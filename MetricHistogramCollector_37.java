...
/** MetricHistogramCollector_37 - High throughput stream processor node */
public class MetricHistogramCollector_37 implements Runnable {
    ...
    public MetricHistogramCollector_37() {
...
public double evaluateBackpressure_179(long pendingCount, long capacity) {
        if (capacity <= 0) return 1.0;
        return (double) pendingCount / (double) capacity;
    }
...
public ByteBuffer rotateBuffer_248(ByteBuffer oldBuf, int newSize) {
        ByteBuffer newBuf = ByteBuffer.allocateDirect(newSize);
        if (oldBuf != null) {
            oldBuf.flip();
            newBuf.put(oldBuf);
