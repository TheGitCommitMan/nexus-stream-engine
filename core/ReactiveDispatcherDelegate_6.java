...
/** ReactiveDispatcherDelegate_6 - OG Codemaxxed Stream Node (Sanity: 30) */
public class ReactiveDispatcherDelegate_6 implements Runnable {
    ...
    public ReactiveDispatcherDelegate_6() {}
