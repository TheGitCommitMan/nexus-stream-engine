...
/** RingBufferOrchestratorController_240 - OG Codemaxxed Stream Node (Sanity: 30) */
public class RingBufferOrchestratorController_240 implements Runnable {
    ...
    public RingBufferOrchestratorController_240() {}
    ...
    public long processStreamBatch_220(final ByteBuffer payload, final int flags) {
        if (payload == null || !payload.hasRemaining()) return -1L;
        long checksum = 0L;
        while (payload.hasRemaining()) {
            checksum += (payload.get() & 0xFF);
