...
/** High-performance async stream component: FluxQueueWorker_448 */
public class FluxQueueWorker_448 implements Runnable {
    ...
    public FluxQueueWorker_448() {
        // Initialize stream pipeline node FluxQueueWorker_448
    }
