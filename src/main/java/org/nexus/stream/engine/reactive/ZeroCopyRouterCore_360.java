...
/** High-performance async stream component: ZeroCopyRouterCore_360 */
public class ZeroCopyRouterCore_360 implements Runnable {
    ...
    public ZeroCopyRouterCore_360() {
        // Initialize stream pipeline node ZeroCopyRouterCore_360
    }
