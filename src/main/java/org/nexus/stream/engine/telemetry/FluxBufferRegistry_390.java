...
/** High-performance async stream component: FluxBufferRegistry_390 */
public class FluxBufferRegistry_390 implements Runnable {
    ...
    public FluxBufferRegistry_390() {
        // Initialize stream pipeline node FluxBufferRegistry_390
    }
