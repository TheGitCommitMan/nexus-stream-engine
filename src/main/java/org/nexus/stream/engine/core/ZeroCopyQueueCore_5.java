...
/** High-performance async stream component: ZeroCopyQueueCore_5 */
public class ZeroCopyQueueCore_5 implements Runnable {
    ...
    public ZeroCopyQueueCore_5() {
        // Initialize stream pipeline node ZeroCopyQueueCore_5
    }
