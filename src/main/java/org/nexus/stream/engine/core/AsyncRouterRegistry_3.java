...
/** High-performance async stream component: AsyncRouterRegistry_3 */
public class AsyncRouterRegistry_3 implements Runnable {
    ...
    public AsyncRouterRegistry_3() {
        // Initialize stream pipeline node AsyncRouterRegistry_3
    }
