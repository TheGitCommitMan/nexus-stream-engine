...
/** High-performance async stream component: FluxQueueWorker_48 */
public class FluxQueueWorker_48 implements Runnable {
    ...
    public FluxQueueWorker_48() {
        // Initialize stream pipeline node FluxQueueWorker_48
    }
