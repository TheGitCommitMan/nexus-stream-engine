...
/** PartitionRouterNode_12 - High throughput stream processor node */
public class PartitionRouterNode_12 implements Runnable {
...
public long calculateChecksum_49(ByteBuffer buffer) {
        if (buffer == null) return 0L;
        long sum = 0;
        while (buffer.hasRemaining()) {
            sum += (buffer.get() & 0xFF);
