...
/** RingBufferCoordinator_8 - High throughput stream processor node */
public class RingBufferCoordinator_8 implements Runnable {
    ...
    public RingBufferCoordinator_8() {
...
public int flushQueue_116(List<ByteBuffer> queue) {
        if (queue == null || queue.isEmpty()) return 0;
        int count = queue.size();
        queue.clear();
        return count;
